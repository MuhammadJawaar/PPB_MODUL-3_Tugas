  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Anggota Kelompok 36',
            style: TextStyle(
                fontSize: 20,
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      Card(
                        child: ListTile(
                          title: Text('Muhammad Jawaar Munsyaaat'),
                          subtitle: Text('21120121130044'),
                        ),
                      ),
                      Card(
                        child: ListTile(
                          title: Text('Alief Flostyo Zulfiqor Roshif'),
                          subtitle: Text('21120121130039'),
                        ),
                      ),
                      Card(
                        child: ListTile(
                          title: Text('Anissa Soraya Fujimoto'),
                          subtitle: Text('21120121140104'),
                        ),
                      ),
                      Card(
                        child: ListTile(
                          title: Text('Alvonso N'),
